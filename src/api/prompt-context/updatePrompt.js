...
const updatePrompt = async (payload) => {
  const response = await fetch('https://mbojaegemegtbpvlwjwt.supabase.co/functions/v1/updatePrompt', {
    method: 'POST',
    headers: {
 ...
 * 
 * Example Error Response (400):
 * {"error": "No update fields provided. At least one of updated_prompt_name, updated_prompt_description, updated_prompt_text, updated_agent_type, or updated_tags must be specified"}
 */
