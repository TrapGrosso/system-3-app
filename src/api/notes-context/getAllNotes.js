...
export const useGetAllNotes = (userId) => {
  return useQuery({
    queryKey: ['getAllNotes', userId],
 ...
 * 
 * Example Request:
 * GET /getAllNotes?user_id=bb370a65-08df-4ddc-8a0f-aa5c65fc568f
 * 
