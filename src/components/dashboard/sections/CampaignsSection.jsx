...
/**
 * Helper function to build step variant metric stack data
 * Creates one column per Step×Variant with stacked open/click/reply rates
 */
function buildStepVariantMetricStackData(steps = []) {
  // Group steps by step_number
  const stepGroups = new Map()
